...
/**
 * Reads {@code Authorization: Bearer <token>} from every request, validates the
 * JWT, and populates {@link SecurityContextHolder} with a
 * {@link RedAvoUserDetails} principal if the token is valid.
 */
@Component
